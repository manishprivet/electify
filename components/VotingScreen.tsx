  ...
  return (
    <div className='container'>
      ...
      {data.auth_type === "secret" ? (
        <button
          onClick={() =>
            vote({ voterId, voterSecret, cIndex, authType: "secret" })
          }
        >
          VOTE
        </button>
      ...
      {data.auth_type === "secret" ? null : (
        <p className='privacy'>
          We're only asking your email for verification purpose. We do not use
          it for any marketing or spamming purposes. We do not collect any of
          your data other than your email and store it only till an election is
          valid.
        </p>
      )}
      <style jsx>{`
